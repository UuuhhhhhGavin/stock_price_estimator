...
def get_folder(dir_path:str,target_folder:str):
    try:
        ...
        print('Error checking envs:', e)
    return None

def get_file(dir_path:str,target_file:str):
    try:
...
def add_folder(base_path:str,folder_name:str):
...
def get_fundamentals(stock):
    """Fetches the fundamentals of a stock"""
